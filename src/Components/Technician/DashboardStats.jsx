...
export default function DashboardStats({ technicianId }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 px-2 sm:px-0 mb-4">
      {stats.map((stat, i) => (
        <div
          key={i}
          className="bg-orange-300 rounded-xl p-4 sm:p-5 text-center font-semibold shadow-md"
        >
